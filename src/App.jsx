        ...
        <section id="about" className="h-screen w-full snap-start flex items-center justify-center p-6">
          <div className="max-w-4xl w-full grid md:grid-cols-2 gap-8 z-10">
            <div className="bg-gray-900/40 p-8 rounded-2xl backdrop-blur-md border border-white/10">
              ...
              <div className="mb-6">
                <h3 className="text-lg font-bold text-blue-400">University of Engineering & Management</h3> 
                <p className="text-sm text-gray-400 mb-1">B.Tech in Computer Science and Engineering</p> 
                <p className="text-xs text-gray-500">YGPA: 8.98 (1st Yr), 8.68 (2nd Yr)</p> 
              </div>
              <div>
            ...
            <div className="bg-gray-900/40 p-8 rounded-2xl backdrop-blur-md border border-white/10">
              ...
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start gap-3">
                  ...
                  <p>National Finalist at AI for Good Fest 2026 and Square Hacks (IIT Delhi).</p> 
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-500 mt-1">▹</span>
                  <p>1st Prize in ML CANVAS 2.0 Poster Competition.</p> 
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-500 mt-1">▹</span>
                  <p>5th-year certified Painter and Football Athelete & Table Tennis Player.</p> 
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="max-w-3xl w-full bg-gray-900/40 p-8 rounded-2xl backdrop-blur-md border border-white/10 z-10">
            ...
            <div className="space-y-8">
              <div className="relative pl-6 border-l border-blue-500/30">
                ...
                <p className="text-gray-400 text-sm">Developed a predictive riverbank health model (97% accuracy) and architected the MITTIE IoT ecosystem for soil monitoring.</p> 
              </div>
              <div className="relative pl-6 border-l border-blue-500/30">
          ...
          <div className="max-w-4xl w-full z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-900/60 p-6 rounded-xl border border-white/10 hover:border-blue-500/50 transition-colors">
                <h3 className="text-lg font-bold text-blue-400 mb-2">MITTIE (IoT & AI Agritech)</h3> 
          ...
          <div className="max-w-3xl w-full bg-gray-900/40 p-8 rounded-2xl backdrop-blur-md border border-white/10 z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <h3 className="text-xl font-bold text-blue-400 mt-6 mb-4">AI / ML Focus</h3> 
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <h3 className="text-xl font-bold text-blue-400 mb-4">Professional Certifications</h3> 
                <ul className="space-y-3 text-sm text-gray-300">
                  <li className="flex justify-between items-center border-b border-gray-800 pb-2">
                    <span>AI Developer Professional</span> 
                    <span className="text-blue-500 font-semibold">IBM</span> 
                  </li>
                  <li className="flex justify-between items-center border-b border-gray-800 pb-2">
                  ...
                  <li className="flex justify-between items-center border-b border-gray-800 pb-2">
                    ...
                    <span className="text-blue-500 font-semibold">Univ. of Colorado</span> 
                  </li>
